...
const deepCloneHappyPathTestCase = (deepClone) => {
  ...
  expect(newObj.c).toStrictEqual(obj.c);
};
...
describe('深拷贝', () => {
  describe('简易粗暴版本', () => {
    ...
    it('happy path', () => {
      deepCloneHappyPathTestCase(deepClone);
    });
  });

  describe('简易版本', () => {
    const deepClone = require('../../src/object/clone/simpleDeepClone');
    it('happy path', () => {
      deepCloneHappyPathTestCase(deepClone);
    });
  });
